...
import Adminprotroute from './components/Admincomp/Adminprotroute';
import Admindeshboard from './components/Admincomp/Admindeshboard';
    ...
    <CartProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/Admindeshboard"    // after login as admin redirect
            element={
              <Adminprotroute>
                <Admindeshboard />
              </Adminprotroute>
